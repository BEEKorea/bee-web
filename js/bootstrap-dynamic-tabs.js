			...
			function DynamicTabs() {
				...
				if ($horizontalContainer.parent('.dynamic-tabs-container').length === 0) {
					...
					$horizontalContainer.after(
						"<div class='nav navbar-nav navbar-right dropdown tabs-dropdown'><a href='#' class='btn dropdown-toggle mt-15' data-toggle='dropdown'><span class='glyphicon glyphicon-menu-down' style='font-size: 1.6em;'/></a><ul class='dropdown-menu' role='menu'><div class='dropdown-header visible-xs'><p class='count'>Tabs</p><button type='button' class='close' data-dismiss='dropdown'><span aria-hidden='true'>&times;</span></button><div class='divider visible-xs'></div></div></ul></div>"
					);
				}
